...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(PetProject.ModID + "Resources/images/powers/" + ID.replaceAll(PetProject.ModID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(PetProject.ModID + "Resources/images/powers/" + ID.replaceAll(PetProject.ModID + ":", "") + "84.png");
        if (hiDefImage != null) {
