...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(PetProject.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(PetProject.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(PetProject.makeImagePath("masks/PowerMask.png"));
